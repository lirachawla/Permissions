...
def permissions():
	...
	if user:
		...
		requestedPermissionsheaders = {'Authorization':'Basic Y2Fwc3RvbmU6Q2Fwc3RvbmVANTQzMjEj'}
		...
		activePermissionsheaders = {'Authorization':'Basic Y2Fwc3RvbmU6Q2Fwc3RvbmVANTQzMjEj'}
		...
		expiredPermissionsheaders = {'Authorization':'Basic Y2Fwc3RvbmU6Q2Fwc3RvbmVANTQzMjEj'}
		...
		if request.method=='POST':
			...
			if request.form['submit'].split(':')[0]=='acceptPermission':
				...
				headers = {'Authorization': 'Basic Y2Fwc3RvbmU6Q2Fwc3RvbmVANTQzMjEj'}
